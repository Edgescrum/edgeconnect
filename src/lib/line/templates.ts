...
export function trialWillEnd(info: TrialEndInfo): Record<string, unknown> {
  ...
  return {
    ...
    body: {
      ...
      paddingAll: "20px",
      contents: [
        badgeRow("トライアル終了予定", color),
        {
          type: "text",
          text: `トライアル期間が${info.daysLeft}日後に終了します`,
          size: "lg",
          weight: "bold",
          color: "#333333",
          wrap: true,
        ...
        separator(),
        {
          ...
          contents: [
            primaryButton(
              "プランを確認・変更する",
              `https://liff.line.me/${info.liffId}/provider/billing`,
              color
            ),
            secondaryButton(
              "このまま継続する",
              `https://liff.line.me/${info.liffId}/provider`
            ),
          ],
        },
        footerBrand(),
