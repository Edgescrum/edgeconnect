  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      <div className="w-full max-w-sm rounded-2xl bg-card p-6 shadow-xl">
        ...
        <button
          onClick={handleLogin}
          className="mt-6 flex w-full items-center justify-center gap-2 rounded-xl bg-[#06C755] py-3.5 text-base font-semibold text-white shadow-lg shadow-[#06C755]/25 active:scale-[0.98]"
        >
