      ...
      <section className="px-4 py-10 sm:px-8 sm:py-16">
        <div className="mx-auto max-w-5xl">
          <div className="flex items-center gap-3">
            ...
            <h2 className="shrink-0 text-sm font-bold text-[#06C755] sm:text-base">予約したい方</h2>
            <div className="h-px flex-1 bg-border" />
          </div>
          ...
          <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-3">
            {[
              ...
              <div key={i} className="rounded-2xl bg-card p-5 ring-1 ring-border sm:p-6">
                <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#06C755]/10 text-[#06C755] sm:h-12 sm:w-12">
                  {item.icon}
                </div>
